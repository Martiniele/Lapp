...
public class SearchBar extends LinearLayout implements TextView.OnEditorActionListener, TextWatcher {
    ...
    private OnSearchResultCallback mOnSearchResultCallback; //搜索结果回调接口
    private AutoCompleteTextView mCompleteText;   //自动提示控件
    ...
    private void initResource(Context context) {
        LayoutInflater.from(context).inflate(R.layout.search_base_widget, this, true);
